...
import org.bitcoins.spvnode.messages.{FilterAddMessage, FilterLoadMessage, PingMessage, PongMessage, RejectMessage, VersionMessage}
...
trait ControlMessageGenerator {
  ...
  /**
    * Generates a random [[org.bitcoins.spvnode.messages.VersionMessage]]
  ...
  /**
    * Generates a [[org.bitcoins.spvnode.messages.PingMessage]]
  ...
  /**
    * Generates a [[org.bitcoins.spvnode.messages.PongMessage]]
  ...
  /**
    * Generates a random [[org.bitcoins.spvnode.versions.ProtocolVersion]]
  ...
  /**
    * Generates a [[org.bitcoins.spvnode.messages.control.ServiceIdentifier]]
    * [[https://bitcoin.org/en/developer-reference#version]]
    *
    * @return
    */
  ...
  /**
    * Creates a [[org.bitcoins.spvnode.messages.FilterLoadMessage]]
