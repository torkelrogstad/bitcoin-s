...
import org.bitcoins.spvnode.messages.data._
...
trait DataMessageGenerator {
  ...
  /**
    * Generates a random [[org.bitcoins.spvnode.messages.GetHeadersMessage]]
  ...
  /**
    * Generates a random [[org.bitcoins.spvnode.messages.TypeIdentifier]]
    * [[https://bitcoin.org/en/developer-reference#data-messages]]
    * @return
    */
  ...
  /**
    * Generates a random [[org.bitcoins.spvnode.messages.data.Inventory]]
