...
class BitcoinSpvNodeUtilTest extends FlatSpec with MustMatchers with BitcoinSLogger {
  ...
  it must "block header message that is not aligned with a tcp frame" in {
    ...
    val headersMsg = HeadersMessage(CompactSizeUInt(UInt64(2),1),
      List(BlockHeader(Int32(3150175941L),DoubleSha256Digest("177e777f078d2deeaa3ad4b82e78a00ad2f4738c5217f7a36d9cf3bd11e41817"),
        ...
        UInt32(2637850613L)),
        BlockHeader(Int32(1694049746),DoubleSha256Digest("07b6d61809476830bc7ef862a983a7222997df3f639e0d2aa5902a5a48018430"),
