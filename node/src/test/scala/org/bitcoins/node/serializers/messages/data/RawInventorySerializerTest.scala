...
class RawInventorySerializerTest extends FlatSpec with MustMatchers {
  ...
  val hex = "01000000de55ffd709ac1f5dc509a0925d0b1fc442ca034f224732e429081da1b621f55a"
  "RawInventorySerializer" must "read a inventory object from its hex representation" in {
    ...
    (DoubleSha256Digest(BitcoinSUtil.decodeHex("de55ffd709ac1f5dc509a0925d0b1fc442ca034f224732e429081da1b621f55a")))
  }
