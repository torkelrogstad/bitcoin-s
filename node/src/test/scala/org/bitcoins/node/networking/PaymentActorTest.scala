...
/**
  ...
  */
class PaymentActorTest extends TestKit(ActorSystem("PaymentActorTest")) with ImplicitSender
  with FlatSpecLike with MustMatchers with BeforeAndAfterAll {

  val txId = DoubleSha256Digest.fromHex("0d507a29efb362ce93687f524e7e3a668689e335ba20374c93710efdf7597c5f")
  ...
  "PaymentActor" must "monitor an address, then send SuccessfulPayment or FailedPayment message if that address is not paid in the next block" in {
    ...
    val partialMerkleTree = PartialMerkleTree(transactionCount = UInt32(36),
      hashes = List(DoubleSha256Digest("27f706c39b2ea48d9316d85f513080da35329f3629ecf5f22869e191d38f3553"),
    ...
    val header =  BlockHeader(version = Int32(805306368),
      previousBlockHash = DoubleSha256Digest("1d73fa2ffbdf79c2e78e3312066833c4a264a19b958faf450100000000000000"),
      merkleRootHash = DoubleSha256Digest("9b47cf5d64aa52d7536e2b469891a79ea8488092dc3c2e0ed26dbe9b508cce16"),
      time = UInt32(1472661981), nBits = UInt32(486604799), nonce = UInt32(4219144207L))
    val merkleBlockMsg = MerkleBlockMessage(merkleBlock = MerkleBlock(blockHeader = header, txCount = UInt32(36),
